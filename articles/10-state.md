...
classDiagram
    ...
    class PeaceState
    class SiegeState
    class CounterAttackState

    City o--> CityState : current
    CityState <|.. PeaceState
    CityState <|.. SiegeState
    CityState <|.. CounterAttackState
    PeaceState ..> SiegeState : transition
    SiegeState ..> CounterAttackState : transition
```
