...
classDiagram
    ...
    class BoatTransporter
    class CartTransporter

    CargoOrder o--> Transporter : bridge
    CargoOrder <|-- GrainOrder
    CargoOrder <|-- WeaponOrder
    Transporter <|.. BoatTransporter
    Transporter <|.. CartTransporter
```
