...
classDiagram
    ...
    class GranaryDepartment

    Mediator <|.. CourtMediator
    Department <|-- ArmyDepartment
    Department <|-- FinanceDepartment
    Department <|-- GranaryDepartment
    Department o--> Mediator : reports to
    CourtMediator o--> FinanceDepartment
    CourtMediator o--> GranaryDepartment
```
